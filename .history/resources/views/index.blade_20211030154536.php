...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Dondon Dreams | Landing Page</title>
...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid img-thumbnail rounded-circle" src="img/logo3.png" alt="" width="50" /><span class="text-primary fs-4 ps-2">Dondon Dreams</span></a>
        ...
        <section class="py-0">
            <div class="bg-holder d-none d-md-block" style="background-image:url(img/logo1.png);background-position:right bottom;background-size:contain;">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="container position-relative">
                <div class="row align-items-center min-vh-75 my-lg-8">
                    <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
                        <h1 class="mb-4 display-1 lh-sm">Dondon Dreams</h1>
                        <p class="mt-4 mb-5 fs-1 lh-base">Lagi cape, butuh hiburan? Ayo ke Dondon Dreams ! <br class="d-none d-lg-block" />Berbagai Antraksi disediakan disini. <br class="d-none d-lg-block" />Pesan Sekarang</p><a class="btn btn-lg btn-success hover-top" href="#" role="button">WhatsApp Me</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row flex-md-center">
                    <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
                        <h1 class="fw-bold fs-md-3 fs-xl-5">Berbagai alat surfing dan trip disekitar di pantai dondon.</h1>
