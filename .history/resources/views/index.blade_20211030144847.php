            ...
            <div class="container position-relative">
                <div class="row align-items-center min-vh-75 my-lg-8">
                    <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
                        ...
                        <p class="mt-4 mb-5 fs-1 lh-base">Lagi cape, butuh hiburan? Ayo ke Dondon Dreams ! <br class="d-none d-lg-block" />Berbagai Antraksi disediakan disini. <br class="d-none d-lg-block" />Kontak kami.</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">Sign Up Now</a>
                    </div>
                </div>
            </div>
        </section>
